...
/**
 * todo
 *   org.mybatis.spring.SqlSessionTemplate ，实现 SqlSession、DisposableBean 接口，SqlSession 操作模板实现类。
 *   实际上，代码实现和 org.apache.ibatis.session.SqlSessionManager 超级相似。
 *   或者说，这是 mybatis-spring 项目实现的 “SqlSessionManager” 类
 *
...
public class SqlSessionTemplate implements SqlSession, DisposableBean {
  ...
  public SqlSessionTemplate(SqlSessionFactory sqlSessionFactory, ExecutorType executorType,
    ...
    System.out.println("【SqlSessionTemplate的构造函数】");
  ...
  */
  ...
  //This method forces spring disposer to avoid call of SqlSessionTemplate.close() which gives UnsupportedOperationException
    ...
    /**
     *
     * todo SqlSessionInterceptor ，是 SqlSessionTemplate 的内部类，
     *  实现 InvocationHandler 接口，将 SqlSession 的操作，路由到 Spring 托管的事务管理器中。
