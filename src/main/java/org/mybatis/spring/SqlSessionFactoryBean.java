...
/**
 *  todo org.mybatis.spring.SqlSessionFactoryBean ，
...
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
  ...
  public void afterPropertiesSet() throws Exception {
    System.out.println("【实现afterPropertiesSet方法】");
    ...
    System.out.println("【构建mybats的核心组件：sqlSessionFactory 】");
  ...
  protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
    ...
    if (xmlConfigBuilder != null) {
      try {
        System.out.println("【解析 mybatis-config.xml 配置】");
    ...
    if (this.transactionFactory == null) {
      System.out.println("【初始化 TransactionFactory 对象】");
  ...
  public SqlSessionFactory getObject() throws Exception {
    System.out.println("【SqlSessionFactoryBean# getObject()获取sqlSessionFactory】");
